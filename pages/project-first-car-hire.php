<?php
$pageTitle = 'Renova | First Car Hire - Branding Project';
$metaDescription = 'First Car Hire brand identity project by Renova Creative. Branding and design case study for car hire services.';
$metaKeywords = 'First Car Hire, branding project, brand identity, Renova portfolio, car hire';
  ...
  <div class="max-w-4xl mx-auto">
    ...
    <div class="prose max-w-none animate-on-scroll fade-in-up">
      ...
      <p class="text-gray-700 text-lg leading-relaxed">
        To develop a distinctive brand identity for First Car Hire that communicates reliability, professionalism, and trustworthiness in the car rental industry. The branding should position them as a leading choice for customers seeking quality vehicles and exceptional service, while creating a memorable and modern visual identity.
      </p>
    </div>
  </div>
</section>
    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div id="pdf-toolbar" class="bg-renovaBlue text-white px-4 py-3 flex flex-col md:flex-row items-center justify-between gap-3 mb-4 rounded-t-2xl sticky top-0 z-10">
        ...
        <div class="flex items-center gap-2">
          ...
          <a id="pdf-download" href="../assets/images/portfolio/first_car_hire/First Car Hire Brand Identity Design Doc.pdf" download class="px-3 py-2 bg-renovaGreen text-renovaBlue rounded-lg hover:bg-renovaBrightGreen transition-colors">
...
<script>
  ...
  let scale = 1.5;
  const pdfPath = '../assets/images/portfolio/first_car_hire/First Car Hire Brand Identity Design Doc.pdf';
