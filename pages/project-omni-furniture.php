<?php
$pageTitle = 'Renova | Omni Furniture - Branding Project';
$metaDescription = 'Omni Furniture brand identity project by Renova. Branding and design case study for furniture retail.';
$metaKeywords = 'Omni Furniture, branding project, brand identity, Renova portfolio';
  ...
  <div class="max-w-4xl mx-auto">
    ...
    <div class="prose max-w-none animate-on-scroll fade-in-up">
      ...
      <p class="text-gray-700 text-lg leading-relaxed">
        To create a comprehensive brand identity for Omni Furniture that reflects their commitment to quality, modern design, and customer satisfaction. The branding should establish a strong visual presence that differentiates them in the competitive furniture market while maintaining an approachable and professional image.
      </p>
    </div>
  </div>
</section>
    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div id="pdf-toolbar" class="bg-renovaBlue text-white px-4 py-3 flex flex-col md:flex-row items-center justify-between gap-3 mb-4 rounded-t-2xl sticky top-0 z-10">
        ...
        <div class="flex items-center gap-2">
          ...
          <a id="pdf-download" href="../assets/images/portfolio/omni_furniture/Omni Furniture Brand Identity Design Document.pdf" download class="px-3 py-2 bg-renovaGreen text-renovaBlue rounded-lg hover:bg-renovaBrightGreen transition-colors">
...
<script>
  ...
  let scale = 1.5;
  const pdfPath = '../assets/images/portfolio/omni_furniture/Omni Furniture Brand Identity Design Document.pdf';
