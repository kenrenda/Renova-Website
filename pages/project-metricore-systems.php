<?php
$pageTitle = 'Renova | Metricore Systems - Branding Project';
$metaDescription = 'Metricore Systems brand identity project by Renova. Branding and design case study for technology businesses.';
$metaKeywords = 'Metricore Systems, branding project, brand identity, Renova portfolio';
  ...
  <div class="max-w-4xl mx-auto">
    ...
    <div class="prose max-w-none animate-on-scroll fade-in-up">
      ...
      <p class="text-gray-700 text-lg leading-relaxed">
        To develop a modern and professional brand identity for Metricore Systems that reflects their expertise in technology solutions and systems development. The branding should establish a strong visual presence that communicates innovation, reliability, and technical excellence while maintaining a clean and approachable aesthetic.
      </p>
    </div>
  </div>
</section>
    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div id="pdf-toolbar" class="bg-renovaBlue text-white px-4 py-3 flex flex-col md:flex-row items-center justify-between gap-3 mb-4 rounded-t-2xl sticky top-0 z-10">
        ...
        <div class="flex items-center gap-2">
          ...
          <a id="pdf-download" href="../assets/images/portfolio/metricore_systems/Metricore Systems Brand Identity Design Document.pdf" download class="px-3 py-2 bg-renovaGreen text-renovaBlue rounded-lg hover:bg-renovaBrightGreen transition-colors">
...
<script>
  ...
  let scale = 1.5;
  const pdfPath = '../assets/images/portfolio/metricore_systems/Metricore Systems Brand Identity Design Document.pdf';
